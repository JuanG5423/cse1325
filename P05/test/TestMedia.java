...
public class TestMedia
{
	public static void main(String[] args)
	{
		...
		if (!(media.toString().equals("The Little Shop of Horrors (https://publicdomainmovie.net/movie/the-little-shop-of-horrors-0, 7 points)")))
		{
			System.err.println("FAIL: expected output is \"The Little Shop of Horrors (https://publicdomainmovie.net/movie/the-little-shop-of-horrors-0, 7 points)\" but returned " + media.toString());
			System.exit(69);
		}
